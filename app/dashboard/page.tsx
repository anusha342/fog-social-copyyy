                ...
                {leaderboardData && leaderboardData.leaderboard.length > 0 ? (
                  <div className="mt-3.5 flex flex-col gap-2.5 w-full max-w-md mx-auto">
                    {leaderboardData.leaderboard.slice(0, 3).map((entry) => {
                      ...
                      let rankWidget = (
                        <div className="flex size-7 shrink-0 items-center justify-center font-mono text-xs font-bold rounded-lg bg-zinc-100 text-zinc-700 border border-zinc-200">
                          #{entry.rank}
                        </div>
                      )
